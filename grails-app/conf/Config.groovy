...
//grails.config.locations = ["classpath:grails-restful-config.groovy"]
...
grails.plugin.springsecurity.filterChain.chainMap = [
        '/v2/api/**': 'JOINED_FILTERS,-exceptionTranslationFilter,-authenticationProcessingFilter,-securityContextPersistenceFilter',  // Stateless chain
        '/**': 'JOINED_FILTERS,-restTokenValidationFilter,-restExceptionTranslationFilter'                                          // Traditional chain
]

//security rest
grails.plugin.springsecurity.rest.login.endpointUrl='/v2/api/auth/login'
grails.plugin.springsecurity.rest.logout.endpointUrl='/v2/api/auth/logout'
